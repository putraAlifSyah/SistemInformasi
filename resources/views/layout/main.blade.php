                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false"> <i class="menu-icon fa fa-address-book"></i>Data</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-user-circle"></i><a href="/datakaryawan">Karyawan</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="/datatalent">Talent</a></li>
                            <li><i class="fa fa-television"></i><a href="/datatayangan">Tayangan</a></li>
                            <li><i class="fa fa-building"></i><a href="/datalembaga">Lembaga</a></li>
                        </ul>
                    </li>
                    <li>
            ...
            <div class="header-menu">
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="{{ Auth::user()->profile_photo_url }}">
                        </a>
